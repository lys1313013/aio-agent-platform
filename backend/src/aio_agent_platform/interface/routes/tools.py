...
TOOL_META: dict[str, dict] = {
    ...
    "read_document": {"label": "读取文档", "category": "file"},
    "document_search": {"label": "文档检索", "category": "file"},
    "render_document": {"label": "文档渲染", "category": "file"},
    "view_image": {"label": "查看图片", "category": "file"},
